...
namespace enums {
    ...
    enum user_state {LOGGED, DISCONNECTED, PLAYED, WAIT_FOR_GAME};
    enum network_state {LOGIN, ALL_USERS, GAME_JOIN, GAME_TAKE, LOGOUT, HARD_LOGOUT, GAME_END, GAME_SWITCH_USER,
        GAME_TURN, GAME, PONG, GAME_CHALLENGER, GAME_INVITE, GAME_SETTINGS, GAME_DISCONNECT, GAME_BACK, GAME_CONTINUE,
